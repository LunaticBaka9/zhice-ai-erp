...
CREATE TABLE `category`  (
  ...
  INDEX `idx_category_parent_sort`(`parent_id` ASC, `sort_order` ASC) USING BTREE
...
CREATE TABLE `customer`  (
  ...
  INDEX `idx_customer_contact_person`(`contact_person` ASC) USING BTREE,
  INDEX `idx_customer_phone`(`phone` ASC) USING BTREE,
  INDEX `idx_customer_status`(`status` ASC) USING BTREE,
  INDEX `idx_customer_status_id`(`status` ASC, `id` ASC) USING BTREE,
  INDEX `idx_customer_name_status`(`name` ASC, `status` ASC) USING BTREE
...
CREATE TABLE `goods`  (
  ...
  INDEX `idx_goods_brand`(`brand` ASC) USING BTREE,
  INDEX `idx_goods_category_id`(`category_id` ASC) USING BTREE,
  INDEX `idx_goods_barcode`(`barcode` ASC) USING BTREE,
  INDEX `idx_goods_category_status_time`(`category_id` ASC, `del_flag` ASC, `create_time` ASC) USING BTREE,
  INDEX `idx_goods_spec`(`spec` ASC) USING BTREE,
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES (1, 'FR001', '芒果', NULL, 6, '海南农场', '50个/箱', '箱', '690123456789', 30.00, 50.00, 35.00, 10.00, 200.00, '2026-04-13 15:55:11', '2026-06-11 17:17:28', 0);
...
CREATE TABLE `inventory`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_inventory_goods_warehouse`(`goods_id` ASC, `warehouse_id` ASC) USING BTREE,
  UNIQUE INDEX `uk_inventory`(`goods_id` ASC, `warehouse_id` ASC, `batch_no` ASC) USING BTREE,
  INDEX `idx_inventory_goods_id`(`goods_id` ASC) USING BTREE,
  INDEX `idx_inventory_warehouse_id`(`warehouse_id` ASC) USING BTREE,
  INDEX `idx_inventory_qty_on_hand`(`qty_on_hand` ASC) USING BTREE
...
CREATE TABLE `inventory_alert`  (
  ...
  INDEX `idx_acknowledged`(`acknowledged` ASC) USING BTREE,
...
CREATE TABLE `inventory_operation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_operation_no`(`operation_no` ASC) USING BTREE,
  INDEX `idx_operation_type`(`operation_type` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_goods_id`(`goods_id` ASC) USING BTREE,
  INDEX `idx_from_warehouse`(`from_warehouse_id` ASC) USING BTREE,
  INDEX `idx_to_warehouse`(`to_warehouse_id` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE,
  INDEX `idx_inv_op_operation_no`(`operation_no` ASC) USING BTREE,
  INDEX `idx_inv_op_goods_id`(`goods_id` ASC) USING BTREE,
  INDEX `idx_inv_op_operation_type`(`operation_type` ASC) USING BTREE,
  INDEX `idx_inv_op_status`(`status` ASC) USING BTREE,
  INDEX `idx_inv_op_create_time`(`create_time` ASC) USING BTREE,
  INDEX `idx_inv_op_goods_warehouse_time`(`goods_id` ASC, `from_warehouse_id` ASC, `create_time` ASC) USING BTREE,
  INDEX `idx_inv_op_source_no`(`source_no` ASC) USING BTREE
...
INSERT INTO `notice` VALUES (28, 1, '测试系统日志', '管理员', '功能上线', '', '<p>测试更改</p>', '2026-04-07 11:46:30', 4, '已发布', '[{\"name\":\"124397002.jpg\",\"url\":\"/api/static/upload/picture/1775543068731_124397002.jpg\",\"size\":8537}]');
INSERT INTO `notice` VALUES (29, 1, 'Test', '管理员', '系统更新', 'Test', '<p>testststststst</p>', '2026-06-11 17:36:30', 2, '已发布', '[{\"name\":\"A_small_cup_of_coffee.JPG\",\"url\":\"http://localhost:8080/static/upload/picture/1781170586313_A_small_cup_of_coffee.JPG\",\"size\":32886}]');
...
CREATE TABLE `notice_read_record`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unique_notice_user`(`notice_id` ASC, `user_id` ASC) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 62 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '公告阅读记录表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `notice_read_record` VALUES (61, 29, 1, '2026-06-11 17:36:35');
...
-- ----------------------------
INSERT INTO `operation_log` VALUES (1, '系统', '新增公告', 'controller.com.lunabaka.NoticeController.postNotice()', '[{\"公告标题\":\"测试系统日志\",\"公告类型\":\"功能上线\",\"公告摘要\":\"\",\"公告内容\":\"<p>测试</p>\",\"发布时间\":1775533590377,\"发布作者\":\"管理员\",\"公告状态\":\"已发布\",\"附件\":\"[]\"}]', 33, '0:0:0:0:0:0:0:1', '2026-04-07 11:46:30', '公告管理', '新增');
INSERT INTO `operation_log` VALUES (2, '系统', '修改公告', 'controller.com.lunabaka.NoticeController.updateNotice()', '[{\"公告标题\":\"测试系统日志\",\"公告类型\":\"功能上线\",\"公告摘要\":\"\",\"公告内容\":\"<p>测试更改</p>\",\"发布时间\":1775533590000,\"发布作者\":\"管理员\",\"公告状态\":\"已发布\",\"附件\":\"[{\\\"name\\\":\\\"124397002.jpg\\\",\\\"url\\\":\\\"/api/static/upload/picture/1775543068731_124397002.jpg\\\",\\\"size\\\":8537}]\"}]', 40, '0:0:0:0:0:0:0:1', '2026-04-07 14:24:32', '公告管理', '修改');
INSERT INTO `operation_log` VALUES (3, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin1\",\"密码\":\"123456\"}]', 67, '0:0:0:0:0:0:0:1', '2026-04-07 14:59:17', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (4, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 3, '0:0:0:0:0:0:0:1', '2026-04-07 15:01:23', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (5, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 5, '0:0:0:0:0:0:0:1', '2026-04-07 15:06:15', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (6, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 3, '0:0:0:0:0:0:0:1', '2026-04-07 15:12:06', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (7, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 3, '0:0:0:0:0:0:0:1', '2026-04-07 15:16:15', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (8, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 133, '0:0:0:0:0:0:0:1', '2026-04-07 15:37:40', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (9, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 863, '0:0:0:0:0:0:0:1', '2026-04-13 11:11:35', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (10, '系统', '修改用户状态', 'controller.com.lunabaka.UserController.updateStatus()', '[{\"昵称\":\"芒果\",\"状态\":\"禁用\"}]', 13, '0:0:0:0:0:0:0:1', '2026-04-13 17:14:59', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (11, '系统', '修改用户状态', 'controller.com.lunabaka.UserController.updateStatus()', '[{\"昵称\":\"芒果\",\"状态\":\"禁用\"}]', 1, '0:0:0:0:0:0:0:1', '2026-04-13 17:15:03', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (12, '系统', '修改用户', 'controller.com.lunabaka.UserController.updateInfo()', '[{\"昵称\":\"芒果\"}]', 27, '0:0:0:0:0:0:0:1', '2026-04-13 17:46:26', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (13, '系统', '新增商品', 'controller.com.lunabaka.GoodsController.insertGoods()', '[{\"SKU编码\":\"FR002\",\"商品名称\":\"TEst\",\"品牌\":\"ste\",\"规格型号\":\"tewst\",\"基础单位\":\"箱\",\"参考采购价\":\"20\",\"标准售价\":20,\"成本价格\":20,\"主条码\":\"123123123123\"}]', 6, '0:0:0:0:0:0:0:1', '2026-04-13 17:47:15', '商品管理', '新增');
INSERT INTO `operation_log` VALUES (14, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 140, '0:0:0:0:0:0:0:1', '2026-04-14 11:22:34', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (15, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 168, '0:0:0:0:0:0:0:1', '2026-04-14 13:29:29', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (16, '系统', '修改用户状态', 'controller.com.lunabaka.UserController.updateStatus()', '[{\"昵称\":\" 一号仓库\",\"状态\":\"2\"}]', 17, '0:0:0:0:0:0:0:1', '2026-04-14 14:10:41', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (17, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":2,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:24:14', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (18, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 11, '0:0:0:0:0:0:0:1', '2026-04-14 14:24:22', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (19, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":2,\"createTime\":1776068926000,\"delFlag\":0}]', 8, '0:0:0:0:0:0:0:1', '2026-04-14 14:24:29', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (20, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 11, '0:0:0:0:0:0:0:1', '2026-04-14 14:24:30', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (21, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":2,\"createTime\":1776068926000,\"delFlag\":0}]', 19, '0:0:0:0:0:0:0:1', '2026-04-14 14:26:02', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (22, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 9, '0:0:0:0:0:0:0:1', '2026-04-14 14:26:04', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (23, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":2,\"createTime\":1776068926000,\"delFlag\":0}]', 17, '0:0:0:0:0:0:0:1', '2026-04-14 14:26:13', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (24, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 8, '0:0:0:0:0:0:0:1', '2026-04-14 14:26:15', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (25, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":2,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:26:15', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (26, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 11, '0:0:0:0:0:0:0:1', '2026-04-14 14:26:16', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (27, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":2,\"createTime\":1776068926000,\"delFlag\":0}]', 11, '0:0:0:0:0:0:0:1', '2026-04-14 14:26:16', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (28, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 5, '0:0:0:0:0:0:0:1', '2026-04-14 14:26:58', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (29, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 21, '0:0:0:0:0:0:0:1', '2026-04-14 14:26:59', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (30, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:27:10', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (31, '系统', '修改仓库信息', 'controller.com.lunabaka.WarehouseController.updateWarehouse()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:27:30', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (32, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 11, '0:0:0:0:0:0:0:1', '2026-04-14 14:27:33', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (33, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:28:07', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (34, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 9, '0:0:0:0:0:0:0:1', '2026-04-14 14:28:47', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (35, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 23, '0:0:0:0:0:0:0:1', '2026-04-14 14:29:16', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (36, '系统', '修改仓库信息', 'controller.com.lunabaka.WarehouseController.updateWarehouse()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 5, '0:0:0:0:0:0:0:1', '2026-04-14 14:29:41', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (37, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:29:44', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (38, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 11, '0:0:0:0:0:0:0:1', '2026-04-14 14:31:07', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (39, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:32:07', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (40, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 6, '0:0:0:0:0:0:0:1', '2026-04-14 14:32:13', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (41, '系统', '修改仓库信息', 'controller.com.lunabaka.WarehouseController.updateWarehouse()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 10, '0:0:0:0:0:0:0:1', '2026-04-14 14:32:20', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (42, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 8, '0:0:0:0:0:0:0:1', '2026-04-14 14:32:24', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (43, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 18, '0:0:0:0:0:0:0:1', '2026-04-14 14:33:47', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (44, '系统', '新增仓库', 'controller.com.lunabaka.WarehouseController.insertGoods()', '[{\"code\":\"F2\",\"name\":\"Test2\",\"address\":\"2号地址\",\"phone\":\"13242134512\",\"status\":1,\"delFlag\":0}]', 19, '0:0:0:0:0:0:0:1', '2026-04-14 14:35:00', '仓库管理', '新增');
INSERT INTO `operation_log` VALUES (45, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"address\":\"2号地址\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 17, '0:0:0:0:0:0:0:1', '2026-04-14 14:35:00', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (46, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"address\":\"2号地址\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 6, '0:0:0:0:0:0:0:1', '2026-04-14 14:35:04', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (47, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:35:04', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (48, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:35:57', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (49, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"address\":\"2号地址\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 8, '0:0:0:0:0:0:0:1', '2026-04-14 14:35:57', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (50, '系统', '修改仓库信息', 'controller.com.lunabaka.WarehouseController.updateWarehouse()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":1,\"createTime\":1776148499000,\"delFlag\":0}]', 5, '0:0:0:0:0:0:0:1', '2026-04-14 14:36:07', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (51, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 8, '0:0:0:0:0:0:0:1', '2026-04-14 14:36:10', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (52, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 12, '0:0:0:0:0:0:0:1', '2026-04-14 14:36:10', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (53, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:36:11', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (54, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":1,\"createTime\":1776148499000,\"delFlag\":0}]', 8, '0:0:0:0:0:0:0:1', '2026-04-14 14:36:12', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (55, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:36:16', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (56, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:36:16', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (57, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 9, '0:0:0:0:0:0:0:1', '2026-04-14 14:36:30', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (58, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:36:30', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (59, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 6, '0:0:0:0:0:0:0:1', '2026-04-14 14:39:14', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (60, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 17, '0:0:0:0:0:0:0:1', '2026-04-14 14:39:14', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (61, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 5, '0:0:0:0:0:0:0:1', '2026-04-14 14:39:17', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (62, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 5, '0:0:0:0:0:0:0:1', '2026-04-14 14:39:17', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (63, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 6, '0:0:0:0:0:0:0:1', '2026-04-14 14:43:36', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (64, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 10, '0:0:0:0:0:0:0:1', '2026-04-14 14:43:36', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (65, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 6, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:28', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (66, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 6, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:28', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (67, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:28', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (68, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 12, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:28', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (69, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:28', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (70, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 39, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:28', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (71, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 5, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:30', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (72, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 6, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:30', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (73, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 8, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:31', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (74, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":1,\"createTime\":1776148499000,\"delFlag\":0}]', 9, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:32', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (75, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 5, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:34', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (76, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 13, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:34', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (77, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 5, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:39', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (78, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 6, '0:0:0:0:0:0:0:1', '2026-04-14 14:52:39', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (79, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 5, '0:0:0:0:0:0:0:1', '2026-04-14 14:53:03', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (80, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 4, '0:0:0:0:0:0:0:1', '2026-04-14 14:53:03', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (81, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 8, '0:0:0:0:0:0:0:1', '2026-04-14 14:53:06', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (82, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 11, '0:0:0:0:0:0:0:1', '2026-04-14 14:53:06', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (83, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:53:14', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (84, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 9, '0:0:0:0:0:0:0:1', '2026-04-14 14:53:14', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (85, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 6, '0:0:0:0:0:0:0:1', '2026-04-14 14:53:16', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (86, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 11, '0:0:0:0:0:0:0:1', '2026-04-14 14:53:36', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (87, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 13, '0:0:0:0:0:0:0:1', '2026-04-14 14:53:36', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (88, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":0,\"createTime\":1776068926000,\"delFlag\":0}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 14:53:53', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (89, '系统', '修改仓库状态', 'controller.com.lunabaka.WarehouseController.updateStatus()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":0,\"createTime\":1776148499000,\"delFlag\":0}]', 24, '0:0:0:0:0:0:0:1', '2026-04-14 14:53:53', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (90, '系统', '修改仓库信息', 'controller.com.lunabaka.WarehouseController.updateWarehouse()', '[{\"id\":1,\"code\":\"F1\",\"name\":\" 一号仓库\",\"kind\":\"原料仓\",\"address\":\"不知道哪的一仓库\",\"manager\":\"管理员\",\"phone\":\"15421312341\",\"status\":1,\"createTime\":1776068926000,\"delFlag\":0}]', 4, '0:0:0:0:0:0:0:1', '2026-04-14 14:58:09', '用户管理', '修改');
INSERT INTO `operation_log` VALUES (91, '系统', '删除商品', 'controller.com.lunabaka.WarehouseController.deleteGoods()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":1,\"createTime\":1776148499000,\"delFlag\":0}]', 2, '0:0:0:0:0:0:0:1', '2026-04-14 14:58:41', '商品管理', '删除');
INSERT INTO `operation_log` VALUES (92, '系统', '删除商品', 'controller.com.lunabaka.WarehouseController.deleteGoods()', '[{\"id\":2,\"code\":\"F2\",\"name\":\"Test2\",\"kind\":\"半成品仓\",\"address\":\"2号地址\",\"manager\":\"Test2\",\"phone\":\"13242134512\",\"status\":1,\"createTime\":1776148499000,\"delFlag\":0}]', 2, '0:0:0:0:0:0:0:1', '2026-04-14 14:59:04', '商品管理', '删除');
INSERT INTO `operation_log` VALUES (93, '系统', '新增库存作业', 'controller.com.lunabaka.InventoryOperationController.insert()', '[{\"作业单号\":\"WH1776155534114\",\"作业类型\":\"inbound\",\"目标仓库\":\"一号仓库\",\"商品名称\":\"苹果\",\"SKU 编码\":\"APL001\",\"数量\":5,\"单位\":\"个\",\"操作员\":\"Test\",\"状态\":\"pending\",\"备注\":\"\"}]', 12, '0:0:0:0:0:0:0:1', '2026-04-14 16:32:31', '库存作业管理', '新增');
INSERT INTO `operation_log` VALUES (94, '系统', '新增库存作业', 'controller.com.lunabaka.InventoryOperationController.insert()', '[{\"作业单号\":\"WH1776156962129\",\"作业类型\":\"transfer\",\"源仓库\":\"一号仓库\",\"目标仓库\":\"二号仓库\",\"商品名称\":\"苹果\",\"SKU 编码\":\"APL001\",\"数量\":2,\"单位\":\"个\",\"操作员\":\"Test\",\"状态\":\"pending\",\"备注\":\"\"}]', 27, '0:0:0:0:0:0:0:1', '2026-04-14 16:56:17', '库存作业管理', '新增');
INSERT INTO `operation_log` VALUES (95, '系统', '更新库存作业状态', 'controller.com.lunabaka.InventoryOperationController.updateStatus()', '[1,\"completed\"]', 8, '0:0:0:0:0:0:0:1', '2026-04-14 16:56:24', '库存作业管理', '修改');
INSERT INTO `operation_log` VALUES (96, '系统', '更新库存作业状态', 'controller.com.lunabaka.InventoryOperationController.updateStatus()', '[2,\"cancelled\"]', 9, '0:0:0:0:0:0:0:1', '2026-04-14 16:56:45', '库存作业管理', '修改');
INSERT INTO `operation_log` VALUES (97, '系统', '新增库存作业', 'controller.com.lunabaka.InventoryOperationController.insert()', '[{\"作业单号\":\"WH1776157025744\",\"作业类型\":\"outbound\",\"源仓库\":\"一号仓库\",\"商品名称\":\"苹果\",\"SKU 编码\":\"APL001\",\"数量\":1,\"单位\":\"个\",\"操作员\":\"Test\",\"状态\":\"pending\",\"备注\":\"\"}]', 17, '0:0:0:0:0:0:0:1', '2026-04-14 16:57:16', '库存作业管理', '新增');
INSERT INTO `operation_log` VALUES (98, '系统', '更新库存作业状态', 'controller.com.lunabaka.InventoryOperationController.updateStatus()', '[3,\"completed\"]', 5, '0:0:0:0:0:0:0:1', '2026-04-14 16:57:21', '库存作业管理', '修改');
INSERT INTO `operation_log` VALUES (99, '系统', '新增库存作业', 'controller.com.lunabaka.InventoryOperationController.insert()', '[{\"作业单号\":\"WH1776157051705\",\"作业类型\":\"adjustment\",\"源仓库\":\"一号仓库\",\"目标仓库\":\"一号仓库\",\"商品名称\":\"苹果\",\"SKU 编码\":\"APL001\",\"数量\":5,\"单位\":\"个\",\"操作员\":\"TEST\",\"状态\":\"pending\",\"备注\":\"\"}]', 7, '0:0:0:0:0:0:0:1', '2026-04-14 16:57:48', '库存作业管理', '新增');
INSERT INTO `operation_log` VALUES (100, '系统', '更新库存作业状态', 'controller.com.lunabaka.InventoryOperationController.updateStatus()', '[4,\"completed\"]', 8, '0:0:0:0:0:0:0:1', '2026-04-14 17:14:15', '库存作业管理', '修改');
INSERT INTO `operation_log` VALUES (101, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 388, '0:0:0:0:0:0:0:1', '2026-04-15 12:42:53', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (102, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 121, '0:0:0:0:0:0:0:1', '2026-04-15 16:25:02', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (103, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 74, '0:0:0:0:0:0:0:1', '2026-04-15 16:33:20', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (104, '系统', '新增商品', 'controller.com.lunabaka.GoodsController.insertGoods()', '[{\"SKU编码\":\"\",\"img\":\"\",\"商品名称\":\"007\",\"品牌\":\"\",\"规格型号\":\"\",\"基础单位\":\"个\",\"参考采购价\":\"0\",\"标准售价\":0,\"成本价格\":0,\"主条码\":\"\",\"库存数量\":0,\"库存预警上限\":0,\"库存预警下限\":0}]', 47, '0:0:0:0:0:0:0:1', '2026-04-15 16:53:22', '商品管理', '新增');
INSERT INTO `operation_log` VALUES (105, '系统', '新增商品', 'controller.com.lunabaka.GoodsController.insertGoods()', '[{\"SKU编码\":\"\",\"img\":\"\",\"商品名称\":\"007\",\"品牌\":\"\",\"规格型号\":\"500ml/瓶\",\"基础单位\":\"瓶\",\"参考采购价\":\"0\",\"标准售价\":0,\"成本价格\":0,\"主条码\":\"\",\"库存数量\":0,\"库存预警上限\":0,\"库存预警下限\":0}]', 53, '0:0:0:0:0:0:0:1', '2026-04-15 16:59:12', '商品管理', '新增');
INSERT INTO `operation_log` VALUES (106, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 117, '0:0:0:0:0:0:0:1', '2026-04-15 22:40:31', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (107, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 530, '0:0:0:0:0:0:0:1', '2026-04-16 15:03:24', '用户管理', '登录');
INSERT INTO `operation_log` VALUES (108, '系统', '用户登录', 'controller.com.lunabaka.WebController.login()', '[{\"用户名\":\"admin\",\"密码\":\"123456\"}]', 180, '0:0:0:0:0:0:0:1', '2026-04-16 15:47:54', '用户管理', '登录');
...
-- Records of purchase
-- ----------------------------
INSERT INTO `purchase` VALUES (1, 'PO20260414001', 1, 1, '15000.00', 2, '2026-04-14 10:00:00', NULL, '2026-04-14 09:00:00', '2026-04-14 09:00:00', NULL);
INSERT INTO `purchase` VALUES (2, 'PO20260414002', 2, 1, '25000.00', 1, NULL, NULL, '2026-04-14 09:30:00', '2026-04-14 09:30:00', NULL);
INSERT INTO `purchase` VALUES (3, 'PO20260414003', 3, 2, '8000.00', 0, NULL, NULL, '2026-04-14 10:00:00', '2026-04-14 10:00:00', NULL);
INSERT INTO `purchase` VALUES (4, 'PO20260414004', 4, 1, '35000.00', 2, '2026-04-13 15:30:00', NULL, '2026-04-13 14:00:00', '2026-04-13 15:30:00', '2026-04-13 15:30:00');
INSERT INTO `purchase` VALUES (5, 'PO20260414005', 5, 2, '12000.00', 2, '2026-04-12 11:00:00', NULL, '2026-04-12 10:00:00', '2026-04-12 11:00:00', '2026-04-12 11:00:00');
...
CREATE TABLE `purchase_inbound`  (
  ...
  `bill_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '入库单号',
  `warehouse_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '入库仓库ID',
  `status` tinyint(4) NULL DEFAULT 0 COMMENT '状态：0-待确认，1-已确认',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `confirm_time` datetime NULL DEFAULT NULL COMMENT '确认时间',
  PRIMARY KEY (`id`) USING BTREE,
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购入库单表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of purchase_inbound
-- ----------------------------
INSERT INTO `purchase_inbound` VALUES (1, 1, 'IB20260414001', 1, 1, '芒果入库完成', '2026-04-14 10:00:00', '2026-04-14 10:30:00');
INSERT INTO `purchase_inbound` VALUES (2, 4, 'IB20260413001', 1, 1, '智利车厘子等入库', '2026-04-13 15:30:00', '2026-04-13 16:00:00');
INSERT INTO `purchase_inbound` VALUES (3, 5, 'IB20260412001', 2, 1, '饮料类入库', '2026-04-12 11:00:00', '2026-04-12 11:30:00');
...
CREATE TABLE `purchase_inbound_item`  (
  ...
  `purchase_item_id` bigint(20) UNSIGNED NULL DEFAULT NULL COMMENT '采购明细ID',
  `goods_id` int(10) UNSIGNED NOT NULL COMMENT '商品ID',
  `quantity` decimal(12, 2) NOT NULL DEFAULT 0.00 COMMENT '入库数量',
  `unit_price` decimal(12, 2) NOT NULL DEFAULT 0.00 COMMENT '入库单价',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_inbound_id`(`inbound_id` ASC) USING BTREE,
  INDEX `idx_goods_id`(`goods_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购入库明细表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of purchase_inbound_item
-- ----------------------------
INSERT INTO `purchase_inbound_item` VALUES (1, 1, 1, 1, 500.00, 30.00);
INSERT INTO `purchase_inbound_item` VALUES (2, 2, 7, 4, 150.00, 120.00);
INSERT INTO `purchase_inbound_item` VALUES (3, 2, 8, 6, 500.00, 16.00);
INSERT INTO `purchase_inbound_item` VALUES (4, 2, 9, 3, 300.00, 25.00);
INSERT INTO `purchase_inbound_item` VALUES (5, 3, 10, 9, 200.00, 7.50);
INSERT INTO `purchase_inbound_item` VALUES (6, 3, 11, 11, 100.00, 42.00);
INSERT INTO `purchase_inbound_item` VALUES (7, 3, 12, 12, 100.00, 38.00);
INSERT INTO `purchase_inbound_item` VALUES (8, 3, 13, 13, 100.00, 14.00);
...
CREATE TABLE `purchase_item`  (
  ...
  INDEX `idx_purchase_id`(`purchase_id` ASC) USING BTREE,
  INDEX `idx_goods_id`(`goods_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购明细表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of purchase_item
-- ----------------------------
INSERT INTO `purchase_item` VALUES (1, 1, 1, 500.00, 30.00, 15000.00, 1);
INSERT INTO `purchase_item` VALUES (2, 2, 2, 200.00, 80.00, 16000.00, 1);
INSERT INTO `purchase_item` VALUES (3, 2, 5, 300.00, 30.00, 9000.00, 2);
INSERT INTO `purchase_item` VALUES (4, 3, 7, 1000.00, 2.80, 2800.00, 1);
INSERT INTO `purchase_item` VALUES (5, 3, 8, 1000.00, 2.80, 2800.00, 2);
INSERT INTO `purchase_item` VALUES (6, 3, 10, 2000.00, 0.90, 1800.00, 3);
INSERT INTO `purchase_item` VALUES (7, 4, 4, 150.00, 120.00, 18000.00, 1);
INSERT INTO `purchase_item` VALUES (8, 4, 6, 500.00, 16.00, 8000.00, 2);
INSERT INTO `purchase_item` VALUES (9, 4, 3, 300.00, 25.00, 7500.00, 3);
INSERT INTO `purchase_item` VALUES (10, 5, 9, 200.00, 7.50, 1500.00, 1);
...
CREATE TABLE `sal_order`  (
  ...
  `warehouse_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '出库仓库ID',
  ...
  `final_amount` decimal(12, 2) NULL DEFAULT 0.00 COMMENT '最终金额',
  `status` tinyint(4) NULL DEFAULT 0 COMMENT '状态：0-草稿，1-已确认，2-已完成，3-已作废',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
...
-- ----------------------------
INSERT INTO `sal_order` VALUES (1, 'SO20260415001', 1, 1, '2026-04-15 09:00:00', 5000.00, 200.00, 4800.00, 1, '鲜丰水果店采购订单', 'admin', '2026-04-15 09:00:00', '2026-04-15 09:30:00', '2026-04-15 09:30:00', NULL);
INSERT INTO `sal_order` VALUES (2, 'SO20260415002', 2, 2, '2026-04-15 10:00:00', 8000.00, 500.00, 7500.00, 2, '百果园饮料采购', 'admin', '2026-04-15 10:00:00', '2026-04-15 14:00:00', '2026-04-15 10:30:00', '2026-04-15 14:00:00');
INSERT INTO `sal_order` VALUES (3, 'SO20260415003', 3, 1, '2026-04-15 11:00:00', 15000.00, 0.00, 15000.00, 1, '盒马鲜生批量采购', 'admin', '2026-04-15 11:00:00', '2026-04-15 11:00:00', '2026-04-15 11:30:00', NULL);
INSERT INTO `sal_order` VALUES (4, 'SO20260416001', 4, 2, '2026-04-16 08:00:00', 3500.00, 300.00, 3200.00, 0, '永辉超市零食采购', 'test', '2026-04-16 08:00:00', '2026-04-16 08:00:00', NULL, NULL);
INSERT INTO `sal_order` VALUES (5, 'SO20260416002', 1, 1, '2026-04-16 09:00:00', 12000.00, 1000.00, 11000.00, 1, '鲜丰水果店追加订单', 'admin', '2026-04-16 09:00:00', '2026-04-16 09:00:00', '2026-04-16 10:00:00', NULL);
...
CREATE TABLE `sal_order_item`  (
  ...
  `product_name_snapshot` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '商品名称快照',
...
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '销售订单明细表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sal_order_item
-- ----------------------------
INSERT INTO `sal_order_item` VALUES (1, 1, 1, '芒果', 50.00, 50, 2500.00, '2026-04-15 09:00:00');
INSERT INTO `sal_order_item` VALUES (2, 1, 3, '阿克苏苹果', 45.00, 30, 1350.00, '2026-04-15 09:00:00');
INSERT INTO `sal_order_item` VALUES (3, 1, 5, '红心火龙果', 60.00, 15, 900.00, '2026-04-15 09:00:00');
INSERT INTO `sal_order_item` VALUES (4, 2, 7, '可乐', 5.00, 500, 2500.00, '2026-04-15 10:00:00');
INSERT INTO `sal_order_item` VALUES (5, 2, 8, '雪碧', 5.00, 400, 2000.00, '2026-04-15 10:00:00');
INSERT INTO `sal_order_item` VALUES (6, 2, 9, '橙汁', 15.00, 150, 2250.00, '2026-04-15 10:00:00');
INSERT INTO `sal_order_item` VALUES (7, 2, 10, '农夫山泉', 2.00, 500, 1000.00, '2026-04-15 10:00:00');
INSERT INTO `sal_order_item` VALUES (8, 3, 4, '智利车厘子', 200.00, 40, 8000.00, '2026-04-15 11:00:00');
INSERT INTO `sal_order_item` VALUES (9, 3, 6, '脐橙', 35.00, 200, 7000.00, '2026-04-15 11:00:00');
INSERT INTO `sal_order_item` VALUES (10, 4, 11, '开心果', 80.00, 20, 1600.00, '2026-04-16 08:00:00');
INSERT INTO `sal_order_item` VALUES (11, 4, 12, '腰果', 75.00, 20, 1500.00, '2026-04-16 08:00:00');
INSERT INTO `sal_order_item` VALUES (12, 5, 1, '芒果', 50.00, 100, 5000.00, '2026-04-16 09:00:00');
INSERT INTO `sal_order_item` VALUES (13, 5, 2, '榴莲', 150.00, 30, 4500.00, '2026-04-16 09:00:00');
INSERT INTO `sal_order_item` VALUES (14, 5, 4, '智利车厘子', 200.00, 10, 2000.00, '2026-04-16 09:00:00');
...
CREATE TABLE `sale_outbound`  (
  ...
  `bill_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '出库单号',
  `warehouse_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '出库仓库ID',
  `status` tinyint(4) NULL DEFAULT 0 COMMENT '状态：0-待确认，1-已确认',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_bill_no`(`bill_no` ASC) USING BTREE,
  INDEX `idx_sale_order_id`(`sale_order_id` ASC) USING BTREE,
  INDEX `idx_warehouse_id`(`warehouse_id` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '销售出库单表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sale_outbound
-- ----------------------------
INSERT INTO `sale_outbound` VALUES (1, 1, 'OB20260415001', 1, 1, '鲜丰水果店发货', '2026-04-15 10:00:00', '2026-04-15 10:30:00');
INSERT INTO `sale_outbound` VALUES (2, 2, 'OB20260415002', 2, 1, '百果园饮料发货', '2026-04-15 14:00:00', '2026-04-15 14:30:00');
INSERT INTO `sale_outbound` VALUES (3, 3, 'OB20260415003', 1, 0, '盒马鲜生待发货', '2026-04-15 12:00:00', NULL);
...
CREATE TABLE `sale_outbound_item`  (
  ...
  `sale_order_item_id` bigint(20) UNSIGNED NULL DEFAULT NULL COMMENT '订单明细ID',
  `product_id` bigint(20) UNSIGNED NULL DEFAULT NULL COMMENT '商品ID',
  `quantity` int(11) NULL DEFAULT 0 COMMENT '出库数量',
  `price` decimal(12, 2) NULL DEFAULT 0.00 COMMENT '出库单价',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_outbound_id`(`outbound_id` ASC) USING BTREE,
  INDEX `idx_product_id`(`product_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '销售出库明细表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sale_outbound_item
-- ----------------------------
INSERT INTO `sale_outbound_item` VALUES (1, 1, 1, 1, 50, 50.00);
INSERT INTO `sale_outbound_item` VALUES (2, 1, 2, 3, 30, 45.00);
INSERT INTO `sale_outbound_item` VALUES (3, 1, 3, 5, 15, 60.00);
INSERT INTO `sale_outbound_item` VALUES (4, 2, 4, 7, 500, 5.00);
INSERT INTO `sale_outbound_item` VALUES (5, 2, 5, 8, 400, 5.00);
INSERT INTO `sale_outbound_item` VALUES (6, 2, 6, 9, 150, 15.00);
INSERT INTO `sale_outbound_item` VALUES (7, 2, 7, 10, 500, 2.00);
...
CREATE TABLE `supplier`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_code`(`code` ASC) USING BTREE,
  UNIQUE INDEX `uk_supplier_code`(`code` ASC) USING BTREE,
  INDEX `idx_supplier_name`(`name` ASC) USING BTREE,
  INDEX `idx_supplier_contact_person`(`contact_person` ASC) USING BTREE,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', '$2a$10$TAaQrJuqFfcc8qx.ClKWDedN7QPFQaRFTuo2oMskPZsUqljjXMpqm', '管理员', 'admin@test.com', '超级管理员', '研发组', '14325345231', 'BioHazard 1', '2026-03-19 22:30:00', '启用', '2026-03-19 15:34:57', '2026-06-11 17:20:15', 'http://localhost:8080/static/upload/avatars/1781169613562_avatar_1.jpg', 0);
...
CREATE TABLE `warehouse`  (
  ...
  INDEX `idx_warehouse_name`(`name` ASC) USING BTREE,
  INDEX `idx_warehouse_kind`(`kind` ASC) USING BTREE,
  INDEX `idx_warehouse_status`(`status` ASC) USING BTREE,
  INDEX `idx_warehouse_status_time`(`status` ASC, `create_time` ASC) USING BTREE
