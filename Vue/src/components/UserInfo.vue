<template>
    ...
    <!-- 修改密码对话框 -->
    <el-dialog v-model="passwordDialog.visible" title="修改密码" width="400px" :close-on-click-modal="false">
        <el-form ref="passwordFormRef" :model="passwordDialog.form" :rules="passwordDialog.rules" label-width="100px">
    ...
    <!-- 修改手机对话框 -->
    <el-dialog v-model="phoneDialog.visible" title="修改手机" width="400px" :close-on-click-modal="false">
        <el-form ref="phoneFormRef" :model="phoneDialog.form" :rules="phoneDialog.rules" label-width="100px">
            ...
            <el-form-item label="新手机号" prop="newPhone">
                <el-input v-model="phoneDialog.form.newPhone" placeholder="请输入新手机号" />
            </el-form-item>
        ...
        <template #footer>
            <span class="dialog-footer">
                ...
                <el-button type="primary" @click="submitPhone" :loading="phoneDialog.loading"> 确认修改 </el-button>
            </span>
        </template>
    </el-dialog>

    <!-- 修改邮箱对话框 -->
    <el-dialog v-model="emailDialog.visible" title="修改邮箱" width="400px" :close-on-click-modal="false">
        <el-form ref="emailFormRef" :model="emailDialog.form" :rules="emailDialog.rules" label-width="100px">
            ...
            <el-form-item label="新邮箱" prop="newEmail">
                <el-input v-model="emailDialog.form.newEmail" placeholder="请输入新邮箱" />
            </el-form-item>
            <el-form-item label="验证码" prop="code">
                <div class="code-input-wrapper">
        ...
        <template #footer>
            <span class="dialog-footer">
                ...
                <el-button type="primary" @click="submitEmail" :loading="emailDialog.loading"> 确认修改 </el-button>
            </span>
        </template>
    </el-dialog>
    ...
    >
        ...
        <template #footer>
            <span class="dialog-footer">
                ...
                <el-button type="primary" @click="submitProfile" :loading="profileDialog.loading"> 保存修改 </el-button>
            </span>
        </template>
    </el-dialog>
</template>
